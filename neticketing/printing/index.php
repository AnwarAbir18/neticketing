...
$query_insertData = "INSERT into purchase_info (user_id, purchase_date, journey_date, source, destination, launch_name, catagory, amount, tnr)
VALUES ('$user_id', '$purchase_date', '$journey_date', '$source', '$destination', '$launch_name', '$seat_catagory', '$cabin', '$tnr')";
