...
mysql_select_db($database_neticketing, $neticketing);
$query_purchaseInfo = sprintf("SELECT purchase_date, journey_date, source, destination, launch_name, tnr 
  FROM purchase_info 
  WHERE user_id = '".$_SESSION['user_id']."'
  ORDER BY journey_date ASC", GetSQLValueString($colname_purchaseInfo, "int"));
...
<div id="signup_body" class="account_body" style="padding-top:  0px;">
  ...
  <div id="dashboard" style="margin-top: 30px; ">
    ...
    <br/>
    <div>
      <div class="title_home"><font style="padding-left: 10px; font-family: arial; font-size: 16px; font-weight: bold; color: #000; "> Successful Purchase Information</font></div>
